...
class StandingsSpreadsheetViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate  {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == self.CollectionView1 {
            ...
            if indexPath.row < 9{
                cell.posLabel.font = UIFont.boldSystemFont(ofSize: fontSize)
            }
            else{
            ...
            if indexPath.row < 9{
                cell.posLabel2.font = UIFont.boldSystemFont(ofSize: fontSize)
            }
            else{
            ...
            if indexPath.row < 9{
                cell.posLabel3.font = UIFont.boldSystemFont(ofSize: fontSize)
            }
            else{
            ...
            if indexPath.row < 9{
                cell.posLabel4.font = UIFont.boldSystemFont(ofSize: fontSize)
            }
            else{
            ...
            if indexPath.row < 9{
                cell.posLabel5.font = UIFont.boldSystemFont(ofSize: fontSize)
            }
            else{
